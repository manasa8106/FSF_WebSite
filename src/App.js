      ...
      <Col xs={12} md={3} style={{ marginBottom: '20px' }}>
        <Row>
          ...
          <Col xs={10} md={10} style={{ paddingLeft: '0' }}>
            ...
            <ul style={{ listStyle: 'none', padding: '0', margin: '30px 0' }}>
              <li><a href="https://www.linkedin.com/company/fullstackfreshers/?originalSubdomain=in" target="_blank" style={{ textDecoration: 'none', color: '#ffffff'}}><i className="fab fa-facebook-f" style={{ fontSize: '36px', marginRight: '10px' }}></i></a></li>
